  ...
  return (
    <div className="flex flex-col justify-center items-center gap-y-6 bg-white py-32">
      <div className="text-center text-3xl font-semibold">
        Select Your <span className="text-hcolor">Package</span>
      </div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-10 gap-x-6 items-stretch">
      {packages.map((pkg, index) => (
        <div
          key={index}
          className="bg-[#F9FAFB] rounded-lg shadow-lg p-6 flex flex-col h-full max-w-xs"
        >
          <Image src={BotIcon} width={100} height={100} alt="" />
          <div className="w-full text-end text-red-500 font-semibold">
            <span className="">
          ...
          <div className="mb-2 w-full text-center text-hcolor text-sm">
            {pkg.currency}
          </div>
          ...
          <ul className="flex flex-col flex-grow gap-y-5 mt-4">
            <li className="flex justify-start items-center gap-x-1">
              <IoIosCheckmarkCircle className="mr-2 size-6 text-hcolor " />
              Trade&nbsp;
              <span className="text-hcolor font-bold">
            ...
            {pkg.features.oneToOneSupport && (
              <li className="flex items-center">
                ...
                <span>
                  {index === 2 || index === 3 ? (
                    <span>
                      <span className="text-hcolor">1-1</span> Support
                    </span>
                  ) : (
                    pkg.features.oneToOneSupport
                  )}
