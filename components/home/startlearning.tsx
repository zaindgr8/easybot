...
//       <div className="text-center w-full border-2 border-black sm:text-2xl font-bold lg:text-4xl md:font-semibold leading-normal">
...
//   return (
//     <div className="">
//       <div className="flex flex-col md:flex-row-2 space-y-10  lg:flex-row md:justify-evenly ">
//         <div className="flex flex-col gap-y-4 items-center  text-center shadow-xl shadow-[#EDF1F9] py-10 px-5 lg:mx-5 lg:w-1/3 rounded-3xl bg-white">
...
//           </p>
//         </div>
//         <div className=" flex flex-col w-full  gap-y-4 items-center  text-center shadow-xl shadow-[#EDF1F9] py-10 px-5 lg:mx-5 lg:w-1/3 rounded-3xl bg-white">
