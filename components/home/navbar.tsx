        ...
        <div id="nav-navigation" className="flex">
          <ul className="flex flex-row space-x-12">
            ...
            <li>
              <Link
                href="/login"
                className="border-2 text-md font-normal border-black rounded-full hover:bg-hcolor hover:border-0 px-6 py-3"
              >
                LOGIN
              </Link>
            </li>
        ...
        <div className="flex flex-col py-3 w-full md:hidden mt-4">
          <ul className="flex flex-col justify-center items-center space-y-4 text-sm w-full">
            ...
            <li className="w-full">
              <Link
                href="/login"
                className="text-hcolor block text-md font-normal text-center w-full"
              >
                LOGIN
              </Link>
            </li>
